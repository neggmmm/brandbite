  ...
  return (
    <div className="relative">
      ...
      <Dropdown
        ...
        className="fixed inset-x-4 top-20 z-[9999] flex h-[70vh] max-h-[480px] flex-col rounded-2xl border border-gray-200 bg-white p-3 shadow-theme-lg dark:border-gray-800 dark:bg-gray-dark sm:absolute sm:inset-auto sm:right-0 sm:top-auto sm:mt-[17px] sm:w-[361px] sm:h-[480px]"
      >
