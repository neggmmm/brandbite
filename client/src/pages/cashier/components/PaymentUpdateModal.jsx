        ...
        <div className="p-6 space-y-6">
          ...
          <div className="bg-slate-50 dark:bg-gray-800 rounded-xl p-5 shadow-inner">
            ...
            <div className="grid grid-cols-2 gap-5">
              <div>
                <div className="text-xs text-slate-500 dark:text-slate-400 font-semibold">Amount</div>
                <div className="text-lg font-bold text-[#7B4019] mt-1">
                  ${(order.totalAmount || order.total || 0).toFixed(2)}
                </div>
              </div>
              <div>
                <div className="text-xs text-slate-500 dark:text-slate-400 font-semibold">Current Status</div>
            ...
            {order.paymentMethod && (
              <div className="mt-4 pt-4 border-t border-slate-200 dark:border-gray-700">
                <div className="text-xs text-slate-500 dark:text-slate-400 font-semibold">Method</div>
                <div className="text-sm font-bold text-slate-900 dark:text-white capitalize mt-1">
                  {order.paymentMethod}
                </div>
              </div>
          ...
          <div>
            <h3 className="font-bold text-slate-900 dark:text-white mb-3 text-sm">Select Payment Status</h3>
          ...
          <div className="bg-[#FFF1E5] dark:bg-gray-800 rounded-xl p-4 border border-[#7B4019]">
            <div className="text-xs text-[#7B4019] font-semibold mb-1">Customer</div>
