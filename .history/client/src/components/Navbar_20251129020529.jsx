...
export default function Navbar() {
  ...
  return (
    <div className="w-full flex justify-between items-center">
      {i18n.language === "en" && (
        <button onClick={() => i18n.changeLanguage("ar")} className="flex flex-col items-center text-muted">
          <span className="text-xs">AR</span>
        </button>
      )}
      {i18n.language === "ar" && (
        <button onClick={() => i18n.changeLanguage("en")} className="flex flex-col items-center text-muted">
