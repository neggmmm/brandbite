      ...
      <div className="max-w-7xl mx-auto px-4 h-16 flex justify-between items-center">
        <div className="flex gap-6">
          ...
          <Link
            to="/menu"
            className={`flex items-center gap-2 font-medium hover:text-blue-600 transition-colors ${
              isActive('/menu') ? 'text-blue-600' : 'text-gray-700'
            }`}
          >
            <Utensils size={20} />
            {t("menu")}
          ...
          <Link
            to="/rewards"
            className={`flex items-center gap-2 font-medium hover:text-blue-600 transition-colors ${
              isActive('/rewards') ? 'text-blue-600' : 'text-gray-700'
            }`}
          >
            <Gift size={20} />
            {t("rewards")}
        ...
        <div className="flex gap-2 items-center">
          {i18n.language === "en" && (
            <button
              ...
              className="px-3 py-1.5 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors text-gray-700 font-medium"
            >
              AR
            </button>
          )}
