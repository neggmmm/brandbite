...
export default function DesktopNav() {
  ...
  return (
    <div className="hidden md:block fixed top-0 left-0 right-0 bg-gradient-to-r from-blue-50 to-indigo-50 shadow-lg z-50 pt-[10vh]">
      <div className="max-w-7xl mx-auto px-8 h-20 flex justify-center items-center">
